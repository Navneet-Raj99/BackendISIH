...
if __name__ == '__main__':
    ...
    def store_in_mongodb(data):
        ...
        mongo_collection.insert_one({"data":encrypted_data,"timestamp":current_timestamp,"user_id":hiveMQUser})
    ...
    def delete_data_from_csv(file_path, data_to_delete):
        try:
            ...
            # Find and remove the specified rows
    ...
    def upload_to_server(data):
        try:
            for row in data:
                ...
                encryptedData=encryption_before_sending_Data(data_string, hiveMQPassword)
    ...
    def mqtt_thread():
        while True:
            if ser2.in_waiting > 0 and ser.in_waiting>0:
                ...
                #internet_connected = os.system("ping -c 1 google.com") == 0 nevr
                #if True:
